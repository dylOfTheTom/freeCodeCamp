 ...
 * The return 0; statement is the "Exit status" of the program. In simple terms, the program ends with this statement and sends a signal      that indicates whether the program exited successfully, 0 being successful and anything above 1 being an error.
